...
| Python tests | `pytest tests/test_pyneschooldata.py -v`                                       | Python wrapper works correctly                 |
...
system("pip install -e ./pyneschooldata && pytest tests/test_pyneschooldata.py -v")
...
warnings - \[ \] `pytest tests/test_pyneschooldata.py` — all tests
pass - \[ \]
...
![Chart](https://almartin82.github.io/neschooldata/articles/...) \`\`\`
...
|------|------------|----------------|-----------|
| 2021 | Yes        | Yes            | Base year |
| 2022 | Yes        | Yes            |           |
| 2023 | Yes        | Yes            |           |
| 2024 | Yes        | Yes            |           |
| 2025 | Yes        | Yes            |           |

**Data Source:** Nebraska Department of Education - URL:
