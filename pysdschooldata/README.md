...
Python wrapper for South Dakota school enrollment data.

This is a thin rpy2 wrapper around the [sdschooldata](https://github.com/almartin82/sdschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `sdschooldata` R package installed
...
# In R:
# remotes::install_github("almartin82/sdschooldata")

# Then install the Python package
pip install pysdschooldata
```
...
df_multi = sd.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
