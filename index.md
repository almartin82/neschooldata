...
Around 245 districts. Here are fifteen stories hiding in the numbers:
...
**Over 80% Hispanic**. Lexington is one of the most demographically
transformed districts in America.

![Lexington Hispanic
enrollment](https://almartin82.github.io/neschooldata/articles/enrollment_hooks_files/figure-html/lexington-chart-1.png)

Lexington Hispanic enrollment
...
Lincoln: **+8,300** (+24%). Omaha: **-2,000** (-4%). The gap is
narrowing.

![Lincoln vs Omaha
enrollment](https://almartin82.github.io/neschooldata/articles/enrollment_hooks_files/figure-html/lincoln-vs-omaha-chart-1.png)

Lincoln vs Omaha enrollment
...
**Kindergarten is 28% Hispanic. 12th grade is only 20%.** The wave is
coming.

![Demographics by grade
level](https://almartin82.github.io/neschooldata/articles/enrollment_hooks_files/figure-html/hs-diversity-chart-1.png)
...
I-80 districts: **+23,000** (+12%). Rest of state: **-13,000** (-12%).
Two Nebraskas diverging.

![I-80 corridor
growth](https://almartin82.github.io/neschooldata/articles/enrollment_hooks_files/figure-html/i80-chart-1.png)

I-80 corridor growth

------------------------------------------------------------------------

### 15. Native American enrollment in Western Nebraska

Pine Ridge Reservation overlaps into Nebraska. Western districts serve
...
**Tribal districts are 60-85% Native American.** Critical funding for
reservation schools.

![Native American
enrollment](https://almartin82.github.io/neschooldata/articles/enrollment_hooks_files/figure-html/native-chart-1.png)
