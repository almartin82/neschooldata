...
Python wrapper for Nebraska school enrollment data.

This is a thin rpy2 wrapper around the [neschooldata](https://github.com/almartin82/neschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `neschooldata` R package installed
...
# Fetch one year
df = ne.fetch_enr(2025)

# Fetch multiple years
df_multi = ne.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
